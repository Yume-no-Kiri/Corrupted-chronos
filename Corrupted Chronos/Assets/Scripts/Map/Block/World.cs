...
{
    //com de gran es el mapa, en chunks
    public int mapSizeInChunks = 6;
    public int chunkSize = 16, chunkHeight = 100;
    //a quina altura es genera aigua, revisar, probablement inecessari
    public int waterThreshold = 50;
    
    //no se com d'útil és si utilitzem random walk, revisar
    ...
    //aquí hi ha tota la logica per poder aplicar els diferents tipo de blocs
